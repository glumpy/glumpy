...
DATA_EXTENSIONS = ['*.vert', '*.frag', "*.geom", "*.glsl"]
...
if __name__ == "__main__":
    ...
    setup(
        ...
        keywords="OpenGL, GLSL, 2D, 3D, Visualisation, "
                 "Science, Numpy, Graphics, Shaders",
        platform="Any",
        ...
        package_data={
            ...
            'glumpy.library': DATA_EXTENSIONS,
            'glumpy.library.math': DATA_EXTENSIONS,
            'glumpy.library.misc': DATA_EXTENSIONS,
            'glumpy.library.arrows': DATA_EXTENSIONS,
            'glumpy.library.markers': DATA_EXTENSIONS,
            'glumpy.library.colormaps': DATA_EXTENSIONS,
            'glumpy.library.antialias': DATA_EXTENSIONS,
            'glumpy.library.transforms': DATA_EXTENSIONS,
            'glumpy.library.collections': DATA_EXTENSIONS,
        },
