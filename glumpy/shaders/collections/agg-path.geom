...
varying in vec4 v_geom_color[4][1];
varying in float v_geom_antialias[4][1];
varying in float v_geom_linewidth[4][1];
varying in float v_geom_miter_limit[4][1];

varying out vec4  v_color;
varying out float v_antialias;
varying out float v_linewidth;
varying out float v_miter_limit;
...
void main(void)
{
    ...
    float antialias = v_geom_antialias[0][0];
    float linewidth = v_geom_linewidth[0][0];
    float miter_limit = v_geom_miter_limit[0][0];
