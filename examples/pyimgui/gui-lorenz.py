...
from glumpy.transforms import Position, Trackball, Viewport, PanZoom
...
transform = PanZoom(Position(),aspect=0.05)
viewport = Viewport()
...
P1[:,1] = ymax
P1[:,2] = z
ticks.append(P0, P1, linewidth=1, color=(0.3,0.3,0.3,.25))
...
P1[:,2] = z
ticks.append(P0, P1, linewidth=1.5, color=(0.3,0.3,0.3,.25))
P0[:,1] = ymax + 0.015
